...
export function GradientButton({
  ...
  const sizeStyles = {
    ...
    md: "px-5 py-2.5 text-sm md:text-base rounded-[14px] gap-2",
    lg: "px-7 py-3.5 text-base md:text-lg rounded-[14px] gap-2.5 font-semibold",
  };

  const variantStyles = {
    primary:
      "bg-gradient-to-r from-[#16A34A] to-[#15803D] text-white shadow-md hover:shadow-glow-green border border-emerald-600/30",
    secondary:
